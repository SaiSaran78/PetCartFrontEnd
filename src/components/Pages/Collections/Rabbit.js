  ...
  return (
    <div className="AllPetsforRabbit">
      <div className="AlaskaSchwarzRabbit">
        <Link to="/alaskaschwarz" style={{ textDecoration: "none" }}>
          <img
      ...
      <div className="AmericanRabbit">
        <Link to="/american" style={{ textDecoration: "none" }}>
          <img
      ...
      <div className="AngoraRabbit">
        <Link to="/angora" style={{ textDecoration: "none" }}>
          <img
      ...
      <div className="ArgenteRabbit">
        <Link to="/argente" style={{ textDecoration: "none" }}>
          <img
